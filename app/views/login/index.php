...
<?php $this->start('head');  ?>
    ...
    <link rel="stylesheet" href="<?=PROOT?>css/login_mobil.css">
<?php $this->end();  ?>
...
<div class="session">
        ...
        <form action="" class="log-in" autocomplete="off">
            <h4><span>MF Bolig´s</span> kunde login system</h4>
            <p>Følg din tømrer, login og se hvor lagt han er.</p>
            ...
            <a href="#" class="discrete">Ny kunde?</a>
        </form>
    </div>
